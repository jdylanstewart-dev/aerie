...
/*package-local*/ final class PostGoalSatisfactionAction implements AutoCloseable {
  ...
  public PostGoalSatisfactionAction(final Connection connection) throws SQLException {
